...
public class ArsMagicaApi {
	...
	public static final Attribute maxManaBonus = new RangedAttribute("am2.maxManaBonus", 0.0f, 0.0f, Double.MAX_VALUE).func_111117_a("Mana Bonus").setShouldWatch(true);
	//Bonus to max burnout.  Applied additively.
	public static final Attribute maxBurnoutBonus = new RangedAttribute("am2.maxBurnoutBonus", 0.0f, 0.0f, Double.MAX_VALUE).func_111117_a("Burnout Bonus").setShouldWatch(true);
	//Bonus to XP gained.  Applied multiplicatively.
	public static final Attribute xpGainModifier = new RangedAttribute("am2.xpMultiplier", 1.0f, 0.0f, Double.MAX_VALUE).func_111117_a("XP Mutiplier").setShouldWatch(true);
	//Bonus to mana regen rate.  Applied multiplicatively.
	public static final Attribute manaRegenTimeModifier = new RangedAttribute("am2.manaRegenModifier", 1.0f, 0.5f, 2.0f).func_111117_a("Mana Regen Rate Multiplier").setShouldWatch(true);
	//Bonus to burnout reduction rate.  Applied multiplicatively.
	public static final Attribute burnoutReductionRate = new RangedAttribute("am2.burnoutReduction", 1.0f, 0.1f, 2.0f).func_111117_a("Burnout Reduction Rate").setShouldWatch(true);
	...
	/**
	 * Registers the icon to use for the specified skill.  This should be called during the API's registerSkillTreeIcons event for each entry that you registered.  You get a reference to the ISpellIconManager which has the same method, so this is only here for convenience.
	 ...
	 * @param icon The icon to use.  You need to register these icons with the game beforehand during your mod's load phase - AM won't do it for you.
	 */
	@SideOnly(Side.CLIENT)
	public final void registerSkillIcon(String name, Icon icon){
		spellIconManager.registerIcon(name, icon);
	}

	/**
	 * Returns the icon manager.  This is used to register spell icons.
	 */
	@SideOnly(Side.CLIENT)
